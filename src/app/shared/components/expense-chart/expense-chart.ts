...
@Component({
  ...
  template: `
    <div
      class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center h-full"
    >
      <h3 class="text-gray-800 font-bold mb-6 w-full text-left">Gastos por Categoria</h3>
      ...
      <div class="flex flex-col md:flex-row items-center gap-8 w-full">
        ...
        >
          <div
            class="absolute inset-4 bg-white rounded-full flex items-center justify-center flex-col"
          >
            <span class="text-xs text-gray-400 font-medium uppercase">Total Gasto</span>
        ...
        <div class="flex-1 w-full space-y-3">
          ...
          <div class="flex items-center justify-between group">
            ...
            <div class="text-right">
              ...
              <p class="text-[10px] text-gray-400">{{ cat.percentage | number : '1.0-0' }}%</p>
            </div>
          </div>
          }
        </div>
